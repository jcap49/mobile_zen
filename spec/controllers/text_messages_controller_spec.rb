  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested text_message" do
        ...
        TextMessage.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => text_message.to_param, :text_message => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the text_message as @text_message" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TextMessage.any_instance.stub(:save).and_return(false)
        put :update, {:id => text_message.to_param, :text_message => {  }}, valid_session
        assigns(:text_message).should eq(text_message)
      end
